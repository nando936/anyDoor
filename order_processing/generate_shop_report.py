"""
Generate Shop Report for Paul Revere Order
"""
...
print(f"\n[OK] Shop report created: {shop_report_file}")

print("\n" + "=" * 60)
print("Shop Report Complete")
print("File created:")
print(f"  - HTML: {shop_report_file}")
print("\nStopping after shop report as requested.")