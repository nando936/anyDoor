...
def search_files(search_path):
    """Search for order, shop, report files in C shared folder"""
    found_files = []
    ...
    try:
        ...
        for root, dirs, files in os.walk(search_path):
            ...
            dirs[:] = [d for d in dirs if d not in ['node_modules', '.git', 'venv', '__pycache__', 'Windows', 'Program Files', 'Program Files (x86)']]
...
# Search path
search_path = r"\\vmware-host\Shared Folders\C"

print("Searching for order forms and shop reports in C shared folder...")
print("=" * 50)
